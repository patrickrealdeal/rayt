...
require('lazy').setup({
  ...
  { 'navarasu/onedark.nvim',            name = 'onedark',        opts = { style = 'darker' } },
  ...
  { "tjdevries/colorbuddy.nvim"},
  {
    ...
    config = function()
      require("mellifluous").setup({
        tender = {             -- name any of the defined color sets
          color_overrides = {
  ...
  { 'nyoom-engineering/oxocarbon.nvim', name = 'oxocarbonl' },
  { 'savq/melange-nvim',                name = 'melange' },
  { "mcchrish/zenbones.nvim",           name = "zenbones" },
  { "diegoulloao/neofusion.nvim", },
  { "ronisbr/nano-theme.nvim", },
  { 'thimc/gruber-darker.nvim',         name = "gruber" },
...
vim.g.seoulbones = { darkness = 'stark', lighten_noncurrent_window = true }
vim.o.tabstop = 4
